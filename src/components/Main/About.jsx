        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <h4>
                    <FormattedMessage
                        id='description'
                        defaultMessage='My name is Luiz Barros and I am a full stack developer.'
                    />
                </h4>
                <p>
                    <FormattedMessage
                    ...
                    <li>
                        <p>
                            <span>
                                ...
                                Programming, Chess, Football 
                        </p>
                    </li>
                    <li>
                        <p><span>Email: barrosluiz224@gmail.com</span> </p>
                    </li>
                    <li>
                        <p>
                            <span>
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    ...
                    <div>
                        <img alt="Next" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg" />
                        <h5>Next</h5>
                    </div>
                    <div>
                        <img alt="Next" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vuejs/vuejs-original.svg" />
                        <h5>Vue</h5>
                    </div>
                    <div>
                        <img alt="Next" className="icons-skils" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nuxtjs/nuxtjs-original.svg" />
                        <h5>Nuxt</h5>
                    </div>
                    <div>
