...
const Contact = () => (
    ...
    <section className="contactos" id="contactos">
        ...
        <div className="icons">
            <a href="mailto:barrosluiz224@gmail.com" target="_blank" rel="noopener noreferrer" data-aos="zoom-in">
                <div className="layer">
                    <span></span>
                    <span></span>
                    <span></span>
            ...
            <a href="https://t.me/darkhorse52" target="_blank" rel="noopener noreferrer" data-aos="zoom-in">
                <div className="layer">
                    <span></span>
                    <span></span>
                    <span></span>
            ...
            <a href="https://github.com/LuizBarros/" target="_blank" rel="noopener noreferrer" data-aos="zoom-in">
                <div className="layer">
                    <span></span>
                    <span></span>
                    <span></span>
